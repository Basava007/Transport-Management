...
app.post('/add', function(req, res, next){	
	req.assert('name', 'required').notEmpty()           //Validate name
	req.assert('usn', 'required').notEmpty()             //Validate usn
	req.assert('age', 'required').notEmpty()
	req.assert('email', ' required').isEmail()  //Validate email
